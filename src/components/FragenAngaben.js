            ...
            <ul>
                {propsFrage.answer.map((answerItem, answerIndex) =>
                    ...
                    <li>
                        ...
                        {showAnswer.show && propsFrage.correct === answerIndex && showAnswer.optionSelected === answerItem && <span>{"Richtige Antwort"}</span>}
                        {showAnswer.show && showAnswer.optionSelected === answerItem && propsFrage.correct !== answerIndex && <span>{"Falsche Antwort"}</span>}
                    </li>
                )}
            </ul>
        </div>
